...
import string
from yandex_translate import YandexTranslate # from yandex.Translater import Translater


translate = YandexTranslate('trnsl.1.1.20190620T080928Z.059272b876400ab5.db9848757da3b1698721fef656db05d4903c4d1b') # tr = Translater()
